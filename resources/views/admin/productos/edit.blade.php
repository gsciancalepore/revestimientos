                ...
                <div class="p-6 text-gray-900">
                    <form method="post" action="{{ route('productos.update', $producto) }}" class="space-y-6 max-w-xl">
                        ...
                        <div>
                            ...
                            <x-text-input id="slug" name="slug" type="text" class="mt-1 block w-full" :value="old('slug', $producto->slug)" />
                            <p class="mt-1 text-sm text-gray-500">Si se deja vacío se regenera desde el nombre. Debe ser único en todo el catálogo.</p>
