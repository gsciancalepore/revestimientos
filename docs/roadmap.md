...
| H03 | Higiene 03 — oferta, calculadora y cobertura | La oferta se cobra, calculadora única, roturas 500 y cobertura | Products + Orders + Payments | 🟡 **03.a implementada** (2026-09-17, rama `fix/higiene-03a`): HIG-10–HIG-22 más HIG-28a y HIG-33, **462 tests**, sincronías anotadas. Falta PR + fase 03.b (HIG-23–HIG-32) |
...
### Punto de retome — 2026-09-17: fase 03.a implementada, falta PR y 03.b
...
**Lo próximo, en orden**: `revisor-entrega` (pidiéndole que mute) → push + PR a `main` con CI en
verde → merge → `fix/higiene-03b` (HIG-23–HIG-32, solo tests + índices únicos) → PRs paralelos
