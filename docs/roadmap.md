...
| H03 | Higiene 03 — oferta, calculadora y cobertura | La oferta se cobra, calculadora única, roturas 500 y cobertura | Products + Orders + Payments | 🟡 **03.a mergeada** (PR #30, 462 tests); **03.b implementada** (rama `fix/higiene-03b`): HIG-23–HIG-32, solo tests + índices únicos + guard ADMIN_EMAIL. Falta revisión, PR y merge |
...
Falta: verificación local completa, mutación regla por regla, `revisor-entrega`, y PR a `main` (sin
push directo, a pedido del dueño).
