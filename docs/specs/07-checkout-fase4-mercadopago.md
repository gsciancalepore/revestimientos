...
- [ ] `GET /checkout/exito` sin efecto, muestra `payment_error` + botón `POST` reintentar si `mercadopago` + `mp_init_point` presente/ausente por fallo; transferencia muestra instrucciones.
