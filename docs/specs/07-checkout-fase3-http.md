...
- **Estado**: cerrada (2026-09-03) — 196 tests verde, implementada en `feat/checkout-07-fase3-http` y mergeada a `main` (PR #6) (extiende 07.1 estructura + 07.2 `PlaceOrderAction`; no modifica `07-checkout.md` ni `07-checkout-fase2.md`; no implementa `ConfirmPaymentAction`)
