...
- **Estado**: borrador (2026-09-03) — pendiente de aprobación del dueño (extiende 07.1 estructura + 07.2 `PlaceOrderAction`; no modifica `07-checkout.md` ni `07-checkout-fase2.md`; no implementa `ConfirmPaymentAction`)
