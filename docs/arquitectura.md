...
## Pedidos — Gestión (Orders — Spec 08 fase 08.a)

Implementado en `docs/specs/08-gestion-pedidos.md:1` (fase 08.a: dominio, sin HTTP ni pantallas). Cierra el agujero de que el stock no bajaba nunca.
...
- **Sin anticipación**: sin webhook (08.b), sin panel ni vista depósito (08.c), sin ventas por WhatsApp (Spec 08.2), sin `Events`/`Listeners`/`Jobs`, sin movimientos de stock como entidad (ADR-005 → Fase 3).
